        ...
        <div className="bg-white rounded border border-border p-4 mb-6 flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex items-center gap-1.5 px-3 py-2 border border-border rounded bg-white sm:min-w-[180px]">
              <span className="text-sm flex-1 truncate text-[#171A1F]">Todas las Facultades</span>
              <ChevronLeft className="w-4 h-4 text-[#171A1F] rotate-[-90deg] flex-shrink-0" />
            </div>
            <div className="flex items-center gap-1.5 px-3 py-2 border border-border rounded bg-white sm:min-w-[180px]">
              <span className="text-sm flex-1 truncate text-[#171A1F]">Todos los Estados</span>
              <ChevronLeft className="w-4 h-4 text-[#171A1F] rotate-[-90deg] flex-shrink-0" />
            </div>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[#F3F4F6]">
                  <th className="text-left px-4 py-3.5 text-sm font-normal text-[#565D6D] w-[100px]">Código</th>
                  <th className="text-left px-4 py-3.5 text-sm font-normal text-[#565D6D]">Nombre</th>
                  <th className="text-left px-4 py-3.5 text-sm font-normal text-[#565D6D]">Facultad</th>
                  <th className="text-left px-4 py-3.5 text-sm font-normal text-[#565D6D]">Coordinador</th>
                  <th className="text-center px-4 py-3.5 text-sm font-normal text-[#565D6D] w-[150px]">Acciones</th>
                </tr>
              </thead>
              <tbody>
                {careersData.map((career, index) => (
                  <tr key={index} className="border-t border-border">
                    <td className="px-4 py-6 text-sm text-[#171A1F]">{career.code}</td>
                    <td className="px-4 py-6 text-sm text-[#171A1F]">{career.name}</td>
                    <td className="px-4 py-6 text-sm text-[#171A1F]">{career.faculty}</td>
                    <td className="px-4 py-6 text-sm text-[#171A1F]">{career.coordinator}</td>
            ...
            <div key={index} className="bg-white rounded border border-border shadow-sm p-4">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <div className="font-medium text-[#171A1F]">{career.code}</div>
                </div>
              ...
              <div className="mb-2">
                ...
                <div className="text-sm text-[#171A1F]">{career.name}</div>
              </div>
              <div className="mb-2">
                <div className="text-xs text-[#565D6D] mb-1">Facultad</div>
                <div className="text-sm text-[#171A1F]">{career.faculty}</div>
              </div>
              <div>
                <div className="text-xs text-[#565D6D] mb-1">Coordinador</div>
                <div className="text-sm text-[#171A1F]">{career.coordinator}</div>
              </div>
            </div>
          ))}
        </div>

          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded border border-[#DEE1E6] bg-white text-[#565D6D] text-sm placeholder:text-[#565D6D] focus:outline-none focus:ring-2 focus:ring-[#003366]/20 focus:border-[#003366]"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded border border-[#DEE1E6] bg-white text-[#565D6D] text-sm focus:outline-none focus:ring-2 focus:ring-[#003366]/20 focus:border-[#003366] appearance-none bg-[url('data:image/svg+xml;base64,')] bg-[length:16px_16px] bg-[right_0.75rem_center] bg-no-repeat pr-10"
              >
            ...
            <button
              type="submit"
              className="w-full bg-[#003366] text-white font-open-sans text-sm py-2.5 rounded hover:bg-[#003366]/90 transition-colors"
            >
              Iniciar Sesión
            </button>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-[#171A1F] opacity-80 text-sm font-open-sans">
              © 2024 SAGA EPN EUR-ACE. Todos los derechos reservados.
            </p>
